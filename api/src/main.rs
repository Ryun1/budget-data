...
async fn main() -> anyhow::Result<()> {
    ...
    let app = Router::new()
        ...
        .route("/api/treasury-addresses", get(treasury_addresses::list_treasury_addresses))
        .route("/api/treasury-operations", get(treasury_operations::list_treasury_operations))
