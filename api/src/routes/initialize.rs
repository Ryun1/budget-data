...
/// List Initialize transactions (TOM action type = 'initialize')
pub async fn list_initialize_transactions(
    Extension(pool): Extension<PgPool>,
    Query(params): Query<InitializeQuery>,
    ...
    let transactions = sqlx::query_as::<_, Transaction>(
        ...
        WHERE m.label = '1694'
          AND LOWER(m.body::jsonb->'body'->>'event') = 'initialize'
