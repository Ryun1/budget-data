#!/bin/bash
# Initialize the treasury schema in the database
...
DB_NAME="${DB_NAME:-treasury_data}"
DB_USER="${DB_USER:-postgres}"
DB_PASSWORD="${DB_PASSWORD:-postgres}"

echo "Initializing treasury schema..."
echo "  Host: $DB_HOST"
echo "  Port: $DB_PORT"
...
echo "Treasury schema initialized successfully!"
echo ""
echo "Tables created:"
